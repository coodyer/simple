package com.app.server.debug.util;
...
import com.app.server.debug.entity.CtAnnotationEntity;
...
public class SimpleUtil {
	...
	public static CtClassEntity getClassEntity(Class<?> clazz) {
		...
		for (Method method : methods) {
			...
			if(method.getName().equals("loadPets")){
		...
		if(!StringUtil.isNullOrEmpty(ctMethods)){
			ctMethods=(List<CtMethodEntity>) PropertUtil.doSeq(ctMethods, "name");
		}
		...
		if(Modifier.isEnum(clazz.getModifiers())){
